...
st.set_page_config(page_title='AIRBNB ',page_icon=icon,initial_sidebar_state='expanded',
                        layout='wide',menu_items={"about":'This streamlit application was developed by Nesal Prabhu M '})
...
selected = option_menu("MainMenu",
                        options=["OVERVIEW","HOME","DISCOVER","INSIGHTS","ABOUT","RECOMMENDATION"],
                        icons=["list icon","house", "globe","lightbulb","info-circle","bookmark-check"],
                        default_index=1,
                        orientation="horizontal",
                        styles={"container": {"width": "100%","border": "0.5px ridge  ","background-color": "#002b36","primaryColor": "#FF69B4"},
...
if selected == "OVERVIEW":
    ...
    if st.session_state.show_image:
        st.image(image_path, caption='Power BI Dashboard', use_container_width=True)
    

    st.subheader(':red[About :]')
    st.markdown('''
        Nesal Prabhu M
         🎓 Education: M.Sc. Mathematics graduate</h5>
         📊 Interests: Data Science, Data Analytics, and Business Intelligence</h5>
         🚀 Current Journey: Exploring the exciting world of Data Science and Analytics to solve real-world problems using data-driven insights.</h5>
         💡 Skills: Proficient in Python, SQL, Power BI, Tableau, R Programming, and more.</h5>
         📚 Learning Goals: Advanced Data Engineering, Machine Learning, and Big Data Technologies.
         🌐 Connect:</h5>
        <h5>- <a href="https://www.linkedin.com/in/nesal-prabhu-a80a01278" target="_blank">LinkedIn Profile</a></h5>
...
if selected == "HOME":
    ...
    with col2:
        st.image("https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExN292YXdvdjhnZ3djYXhhenhlMXkyem0xcDdwYjZzcWYxNTdoYmlyaiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/AErExHJVxRbkm5hPkB/giphy.gif",use_container_width=True)
...
#set up the details for option 'About'
    ...
    st.title(":red[Recommendations for Airbnb]")
    st.subheader("Based on our analysis,recommend the following actions:")
        ...
        "Revenue Optimization": [
            {
                ...
                "details": (
                    "Use tools to adjust pricing based on demand, seasonality, and local events. "
                    "Dynamic pricing can help maximize revenue."
                ),
            },
            {
                "title": "Offer Long-Term Stay Discounts",
                "details": (
                    "Provide discounts for stays longer than a week or month to attract long-term guests, "
                    "such as digital nomads and remote workers."
                ),
            },
        ],
        "Customer Experience": [
            {
                "title": "Enhance Property Listings",
                "details": (
                    "Use professional images and engaging descriptions with keywords for amenities and attractions. "
                    "This improves visibility and guest appeal."
                ),
            },
            {
                "title": "Improve Communication",
                "details": (
                    "Automate messages for check-ins, follow-ups, and queries. Prompt communication enhances guest satisfaction."
                ),
            },
        ],
        "Strategic Investment": [
            {
                "title": "Invest in Key Locations",
                "details": (
                    "Focus on properties near tourist attractions, business hubs, and transport hubs to attract a steady stream of guests."
                ),
            },
            {
                "title": "Leverage Guest Reviews",
                "details": (
                    "Monitor reviews to identify strengths and areas for improvement. Positive reviews boost your listing's ranking."
                ),
            },
        ],
    }
    ...
    for category, recs in recommendations.items():
        ...
        for i, rec in enumerate(recs, 1):
            ...
            st.divider()  # Add a divider for readability

    st.subheader("That's all about my project Thank You")
